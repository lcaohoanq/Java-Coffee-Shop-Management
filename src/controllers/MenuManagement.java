    ...
    public void updateDrink(){
        ...
        do{
            ...
            if(menuDrinkItem == null) {
                ...
                MenuStructure menu = new MenuStructure("Update drink option");
                menu.addOption("Add new ingredient");
                menu.addOption("Remove ingredient");
                menu.addOption("Adjust ingredient");
